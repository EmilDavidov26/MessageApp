...
public class FriendsListAdapter extends RecyclerView.Adapter<FriendsListAdapter.ViewHolder> {
    ...
    public FriendsListAdapter(Context context, List<User> friendsList, OnFriendActionListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Set the remove friend button
        holder.friendButton.setText("Remove Friend");
        holder.friendButton.setOnClickListener(v -> listener.onRemoveFriend(user));
